      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 px-6 py-4 bg-white border-b border-slate-200 shrink-0">
        <div>
          <h1 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <CalendarDays className="w-5 h-5 text-[#0EA5E9]" /> Agenda
          </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-slate-100 rounded-xl p-1">
            ...
            <button onClick={() => setWeekOffset(0)} className="px-3 py-1.5 text-xs font-bold text-slate-600 hover:bg-white rounded-lg transition-colors uppercase tracking-wider">
              Hoy
            </button>
            <button onClick={() => setWeekOffset(prev => prev + 1)} className="p-2 hover:bg-white rounded-lg transition-colors">
          ...
          <button 
            ...
            className="bg-[#0EA5E9] hover:bg-[#0284C7] text-white px-4 py-2 rounded-xl font-semibold text-sm flex items-center transition-colors shadow-sm gap-2"
          >
                    ...
                    {cellAppointments.map(appt => {
                      ...
                      return (
                        <motion.div
                          ...
                          style={{ 
                            backgroundColor: '#0EA5E9', // Fixed color for now
                        ...
                        >
                          ...
                          <div className="opacity-80 truncate flex items-center gap-1 mt-0.5">
                            ...
                            {appt.hora.substring(0, 5)} - {appt.duracion_min}m
                          </div>
                          <div className="opacity-70 truncate mt-0.5">{appt.tratamiento}</div>
                        </motion.div>
                      );
                    })}
                  </div>
